  ...
  List<ProjectModel> fetchAllProjects() {
    ...
    List<ProjectModel> projectList = [
      ProjectModel(
        ...
        'https://github.com/Aman-Shaikh/Coffe-Shop-Beautifull-UI',
      ),
      ProjectModel(
        ...
        'https://github.com/Aman-Shaikh/Car-Controller-Getx-Flutter',
      ),
      ProjectModel(
          'Neumorphic Clockify',
          ...
          'https://github.com/Aman-Shaikh/Neumorphic-Analog-Clockify'),
      ProjectModel(
          'CUI Aider',
      ...
      ProjectModel(
          ...
          'https://github.com/Aman-Shaikh/Neumorphic-Music_Player-Flutter'),
      ProjectModel(
          'Food Recipe App',
          ...
          'https://github.com/Aman-Shaikh/Food-Recipe-App-Flutter'),
      ProjectModel(
          'Task Sync Pro',
          ...
          'https://github.com/Aman-Shaikh/Task-Sync-Pro-Flutter'),
      ProjectModel(
          ...
          'https://github.com/Aman-Shaikh/Messenger-App-Backend-Firebase'),
      ProjectModel(
          ...
          'https://github.com/Aman-Shaikh/Doctor-Appointment-Application-UI'),
    ];
    return projectList;
  }
